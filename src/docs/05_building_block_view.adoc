...
----
!include /project/src/docs/includes/C4_Container.puml
...
System_Boundary(c1, "Pico Travel") {
    Container(browserApp, "Web Application", "Ionic, Static webapp", "Browser application")
    Container(iosApp, "iOS Application", "Static web application", "Browser application")
    Container(androidApp, "Android Application", "Ionic, Cordova", "Browser application")
    Container(authApp, "Pico Travel Auth", "Azure Functions, C#, .Net Core", "Authentification")
    Container(backendApp, "Pico Travel Back", "Azure WebApp, Spring Boot, Java", "Backend")
    ContainerDb(nosql, "Data Store", "Azure CosmosDB", "Stores places data, devices & comments")
}
